        ...
        <section class="pricing">
            ...
            <div class="box-container">
                <div class="box">
                    ...
                    <div class="list">
                        <p><i class="fas fa-check"></i></i>photography</p>
                        <p><i class="fas fa-check"></i></i>bride makeup</p>
                        <p><i class="fas fa-check"></i></i>wedding ceremony</p>
                        <p><i class="fas fa-check"></i></i>meals & drinks</p>
                        <p><i class="fas fa-check"></i></i>guest invitations</p>
                    </div>
